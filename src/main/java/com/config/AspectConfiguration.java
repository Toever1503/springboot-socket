...
public class AspectConfiguration {
    @Around("execution(* com.service.*.*(org.springframework.data.domain.Pageable, ..))") // pointcut expression only apply with these methods service has first parameter type is Pageable
